...
| `acBaterieStorageOffset` | set the *Offset* of AC Batteries energy if nedded in (Wh),(+/-) (not available from v4.9.0)|
            ...
            "devices": [
                {
                    ...
                    "installerPasswd": "",
                    "acBateriesStorageOffset": 0, //removed from 4.9.0 not nedded anymore
