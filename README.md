...
* Exposed accessory in the native Home app:
  ...
  * Sensors:
    ...
    * Grid Mode:
      * Enpower `Grid On`, `Grid Off`, `Multimode Grid On`, `Multimode Grid Off`, `Grid Tied`, `Grid Forming`, `Grid Interactive`, `Utility Interactive`.
      * Encharge `Grid On`, `Grid Off`, `Multimode Grid On`, `Multimode Grid Off`, `Grid Tied`, `Grid Forming`, `Grid Interactive`, `Utility Interactive`.
      * Solar `Grid On`, `Grid Off`, `Multimode Grid On`, `Multimode Grid Off`, `Grid Tied`, `Grid Forming`, `Grid Interactive`, `Utility Interactive`.
...
| `enepowerGridModeSensors.gridMode` | Here select the grid mode `Grid On`, `Grid Off`, `Multimode Grid On`, `Multimode Grid Off`, `Grid Tied`, `Grid Forming`, `Grid Interactive`, `Utility Interactive` for sensor. |
...
| `enchargeGridModeSensors.gridMode` | Here select the grid mode `Grid On`, `Grid Off`, `Multimode Grid On`, `Multimode Grid Off`, `Grid Tied`, `Grid Forming`, `Grid Interactive`, `Utility Interactive` for sensor. |
...
| `solarGridModeSensors.gridMode` | Here select the grid mode `Grid On`, `Grid Off`, `Multimode Grid On`, `Multimode Grid Off`, `Grid Tied`, `Grid Forming`, `Grid Interactive`, `Utility Interactive` for sensor. |
