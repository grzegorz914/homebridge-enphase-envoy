...
class EnvoyDevice extends EventEmitter {
    ...
    async checkJwtToken() {
        ...
        try {
            ...
            this.emit('error', `Requesting check JWT token error: ${error}`);
        };
    };
    ...
    async getJwtToken() {
        ...
        try {
            ...
            this.emit('error', `Requesting JWT token error: ${error}`);
        };
    };
    ...
    async validateJwtToken() {
        ...
        try {
            ...
            this.emit('error', `Requeating validate JWT token error: ${error}`);
        };
    };
    ...
    async getEnvoyBackboneApp() {
        ...
        try {
            ...
            this.emit('error', `Requesting envoy dev Id from file error: ${error}.`);
        };
    };
    ...
    async updateInfo() {
        ...
        try {
            ...
            const debug1 = this.enableDebugMode ? this.emit('debug', `Parsed info: ${JSON.stringify(updatedInfoData, null, 2)}`) : false;
            ...
            this.emit('error', `Requesting info error: ${error}.`);
        };
    };
    ...
    async calculateEnvoyPassword() {
        ...
        try {
            ...
            this.emit('error', `Envoy password error: ${error}.`);
        };
    };
    ...
    async calculateInstallerPassword() {
        ...
        try {
            ...
            this.emit('error', `Read installer password error: ${error}.`);
        };
    };
    ...
    async updateHome() {
        ...
        try {
            ...
            this.emit('error', `Requesting home error: ${error}.`);
        };
    };
    ...
    async updateInventory() {
        ...
        try {
            ...
            this.emit('error', `Requesting inventory error: ${error}.`);
        };
    };
    ...
    async updateMeters() {
        ...
        try {
            ...
            //meters installed
            const metersInstalled = this.pv.meters.some(meter => meter.state)
            ...
            return metersInstalled;
        } catch (error) {
            this.emit('error', `Requesting meters error: ${error}.`);
        };
    };
    ...
    async updateMetersReading() {
        ...
        try {
            ...
            this.emit('error', `Requesting meters reading error: ${error}.`);
        };
    };
    ...
    async updateMicroinverters() {
        ...
        try {
            ...
            this.emit('error', `Requesting microinverters error: ${error}.`);
        };
    };
    ...
    async updateProduction() {
        ...
        try {
            ...
            this.emit('error', `Requesting production error: ${error}.`);
        };
    };
    ...
    async updateProductionCt() {
        ...
        try {
            ...
            this.emit('error', `Requesting production ct error: ${error}.`);
        };
    };
    ...
    async updateProductionPowerState() {
        ...
        try {
            ...
            this.emit('error', `Requesting power production state error: ${error}.`);
        };
    }
    ...
    async updateEnsembleInventory() {
        ...
        try {
            ...
            this.emit('error', `Requesting ensemble inventory error: ${error}.`);
        };
    };
    ...
    async updateEnsembleStatus() {
        ...
        try {
            ...
            this.emit('error', `Requesting ensemble status error: ${error}.`);
        };
    };
    ...
    async updateEnchargesSettings() {
        ...
        try {
            ...
            this.emit('error', `Requesting encharge settings. error: ${error}.`);
        };
    };
    ...
    async updateTariff() {
        ...
        try {
            ...
            this.emit('error', `Requesting tariff. error: ${error}.`);
        };
    };
    ...
    async updateDryContacts() {
        ...
        try {
            ...
            this.emit('error', `Requesting dry contacts error: ${error}.`);
        };
    };
    ...
    async updateDryContactsSettings() {
        ...
        try {
            ...
            this.emit('error', `Requesting dry contacts settings error: ${error}.`);
        };
    };
    ...
    async updateGenerator() {
        ...
        try {
            ...
            this.emit('error', `Requesting generator error: ${error}.`);
        };
    };
    ...
    async updateGeneratorSettings() {
        ...
        try {
            ...
            this.emit('error', `Requesting generator settings error: ${error}.`);
        };
    };
    ...
    async updatePlcLevel() {
        ...
        try {
            ...
            this.emit('error', `Requesting plc level error: ${error}.`);
        };
    };
    ...
    async updateLive() {
        ...
        try {
            ...
            this.emit('error', `Requesting live data error: ${error}.`);
        };
    };
